...
<head>
<meta charset="UTF-8">
<title>Registered User Informations.</title>
<style type="text/css">
...
<body>
	<div class="editUsers">
		<h2>Change the details please</h2>
		<form:form method="POST" action="editUser" modelAttribute="user"></form:form>

		First name: <input type="text" name="firstname"
			value="${user.firstName }"> Last name: <input type="text"
			name="lastName" value="${user.lastName }"> Username: <input
			type="text" name="firstname" value="${user.username}"> Phone:
		<input type="text" name="lastname" value="${user.email}">

		Email: <input type="text" name="lastname" value="Mouse"> </input
				
		<form method="GET" action="/ImoProject/editUsers">
