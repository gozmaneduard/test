...
<body>
    <div class="registrationDetails">
        <h2>You have been successfully registered! Pick Your home!</h2>
        <table>
            <tr>
                <td>FirstName</td>
        ...
        <form method="GET" action="/ImoProject/startPage">
            <button type="submit" class="btn btn-primary btn-block btn-large" name="submit">Go to first page</button>
        </form> 
    </div>
</body>
</html>