...
<body>
	<div class="startPage">
		<h2>Your apartment is here. Login and check it out!</h2>
		<form method="GET" action="/ImoProject/login">
			<button type="submit" class="btn btn-primary btn-block btn-large"
				name="submit">Login</button>
		</form>

		<form method="GET" action="/ImoProject/createUser">
			<button type="submit" class="btn btn-primary btn-block btn-large"
