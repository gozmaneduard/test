...
<body>
	<div class="userInfo">
		<h2>Registered Users Info</h2>
		<c:forEach items="${userList}" var="userEntityList">
			<table class="center">
				<tr>
					<td class="id">${userEntityList.id}</td>
					<td>${userEntityList.firstName}</td>
					<td>${userEntityList.lastName}</td>
					<td>${userEntityList.username}</td>
					<td>${userEntityList.phone}</td>
					<td>x${userEntityList.email}</td>
					<td><a href="<c:url value="/deleteUser/${userEntityList.id}" />"
						onclick="return confirm('Are you sure?')">Delete</a></td>
					<td><a href="<c:url value="/editUser/{userEntityList.id"/>">Edit</a></td>
				</tr>
			</table>
		</c:forEach>
	</div>
